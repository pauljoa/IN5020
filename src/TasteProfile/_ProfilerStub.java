...
public class _ProfilerStub extends org.omg.CORBA.portable.ObjectImpl implements TasteProfile.Profiler
{
  ...
  public TasteProfile.TopThree getTopThreeUsersBySong (String song_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_string (song_id);
                $in = _invoke ($out);
                TasteProfile.TopThree $result = TasteProfile.TopThreeHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public TasteProfile.Song getFavouriteSongByUser (String user_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getFavouriteSongByUser", true);
                $out.write_string (user_id);
                $in = _invoke ($out);
                TasteProfile.Song $result = TasteProfile.SongHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return getFavouriteSongByUser (user_id        );
            } finally {
                _releaseReply ($in);
            }
  } // getFavouriteSongByUser

  public TasteProfile.UserProfile getUserProfile (String user_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_string (user_id);
                $in = _invoke ($out);
                TasteProfile.UserProfile $result = TasteProfile.UserProfileHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
