 ...
 implements TasteProfile.ProfilerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getFavouriteSongByUser", new java.lang.Integer (3));
    _methods.put ("getUserProfile", new java.lang.Integer (4));
  }
  ...
  /*Returns top three users by song id*/
       ...
       {
         String song_id = in.read_string ();
         TasteProfile.TopThree $result = null;
         $result = this.getTopThreeUsersBySong (song_id);
         out = $rh.createReply();
         TasteProfile.TopThreeHelper.write (out, $result);
         break;
       }


  /*Returns favorite song by user id*/
       case 3:  // TasteProfile/Profiler/getFavouriteSongByUser
       {
         String user_id = in.read_string ();
         TasteProfile.Song $result = null;
         $result = this.getFavouriteSongByUser (user_id);
         out = $rh.createReply();
         TasteProfile.SongHelper.write (out, $result);
         break;
       }

       case 4:  // TasteProfile/Profiler/getUserProfile
       {
         String user_id = in.read_string ();
         TasteProfile.UserProfile $result = null;
         $result = this.getUserProfile (user_id);
         out = $rh.createReply();
         TasteProfile.UserProfileHelper.write (out, $result);
         break;
       }
